...
map.getView().fit([-16788384.674893, 3226486.298867, -5275689.228568, 7917121.666502], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Website Traffic Map</h2>';
        return titleElement;
    })(),
