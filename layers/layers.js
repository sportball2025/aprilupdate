...
var format_Apr25AutoWebsiteTraffic_7 = new ol.format.GeoJSON();
var features_Apr25AutoWebsiteTraffic_7 = format_Apr25AutoWebsiteTraffic_7.readFeatures(json_Apr25AutoWebsiteTraffic_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Apr25AutoWebsiteTraffic_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Apr25AutoWebsiteTraffic_7.addFeatures(features_Apr25AutoWebsiteTraffic_7);
var lyr_Apr25AutoWebsiteTraffic_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Apr25AutoWebsiteTraffic_7, 
                style: style_Apr25AutoWebsiteTraffic_7,
                popuplayertitle: 'Apr-25 Auto Website Traffic',
                interactive: true,
                title: '<img src="styles/legend/Apr25AutoWebsiteTraffic_7.png" /> Apr-25 Auto Website Traffic'
            });
var format_Apr25ManualWebsiteTraffic_8 = new ol.format.GeoJSON();
var features_Apr25ManualWebsiteTraffic_8 = format_Apr25ManualWebsiteTraffic_8.readFeatures(json_Apr25ManualWebsiteTraffic_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Apr25ManualWebsiteTraffic_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Apr25ManualWebsiteTraffic_8.addFeatures(features_Apr25ManualWebsiteTraffic_8);
var lyr_Apr25ManualWebsiteTraffic_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Apr25ManualWebsiteTraffic_8, 
                style: style_Apr25ManualWebsiteTraffic_8,
                popuplayertitle: 'Apr-25 Manual Website Traffic',
                interactive: true,
                title: '<img src="styles/legend/Apr25ManualWebsiteTraffic_8.png" /> Apr-25 Manual Website Traffic'
            });

lyr_BaseMap_0.setVisible(true);lyr_OutdoorLocations_1.setVisible(true);lyr_IndoorLocations_2.setVisible(true);lyr_Feb25AutoWebsiteTraffic_3.setVisible(true);lyr_Feb25ManualWebsiteTraffic_4.setVisible(true);lyr_Mar25AutoWebsiteTraffic_5.setVisible(true);lyr_Mar25ManualWebsiteTraffic_6.setVisible(true);lyr_Apr25AutoWebsiteTraffic_7.setVisible(true);lyr_Apr25ManualWebsiteTraffic_8.setVisible(true);
var layersList = [lyr_BaseMap_0,lyr_OutdoorLocations_1,lyr_IndoorLocations_2,lyr_Feb25AutoWebsiteTraffic_3,lyr_Feb25ManualWebsiteTraffic_4,lyr_Mar25AutoWebsiteTraffic_5,lyr_Mar25ManualWebsiteTraffic_6,lyr_Apr25AutoWebsiteTraffic_7,lyr_Apr25ManualWebsiteTraffic_8];
...
lyr_Apr25AutoWebsiteTraffic_7.set('fieldAliases', {'Lat': 'Lat', 'Long': 'Long', 'Number of visits': 'Number of visits', 'Month': 'Month', });
lyr_Apr25ManualWebsiteTraffic_8.set('fieldAliases', {'Lat': 'Lat', 'Long': 'Long', 'Number of visits': 'Number of visits', 'Month': 'Month', });
...
lyr_Apr25AutoWebsiteTraffic_7.set('fieldImages', {'Lat': 'TextEdit', 'Long': 'TextEdit', 'Number of visits': 'Range', 'Month': 'TextEdit', });
lyr_Apr25ManualWebsiteTraffic_8.set('fieldImages', {'Lat': 'TextEdit', 'Long': 'TextEdit', 'Number of visits': 'Range', 'Month': 'TextEdit', });
...
lyr_Apr25AutoWebsiteTraffic_7.set('fieldLabels', {'Lat': 'no label', 'Long': 'no label', 'Number of visits': 'inline label - visible with data', 'Month': 'inline label - visible with data', });
lyr_Apr25ManualWebsiteTraffic_8.set('fieldLabels', {'Lat': 'no label', 'Long': 'no label', 'Number of visits': 'inline label - visible with data', 'Month': 'inline label - visible with data', });
lyr_Apr25ManualWebsiteTraffic_8.on('precompose', function(evt) {
